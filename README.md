...
<p><a id="python_sig"></a></p>

<!-- wp:heading {"textAlign":"center"} -->
<h2 class="has-text-align-center"><strong>Python aplicado a los Sistemas de Información Geográfica</strong></h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>En las siguientes entradas aplico los conceptos de Python expuestos en este post al trabajo con la información geográfica tanto en ArcGIS como en QGIS:</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-jetpack-layout-grid-column wp-block-jetpack-layout-grid__padding-none"><!-- wp:a8c/blog-posts {"showDate":false,"showAuthor":false,"postLayout":"grid","postsToShow":12,"mediaPosition":"left","tags":["832"],"imageScale":1} /--></div>
